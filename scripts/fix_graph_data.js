...
if (!html.includes(oldZhai)) {
  console.log('ERROR: 宥辰 pattern not found');
  process.exit(1);
}
...
console.log('relations count:', (v.match(/relations:{me:/g) || []).length);
console.log('Old-style relations count:', (v.match(/relations:{ members:/g) || []).length);
